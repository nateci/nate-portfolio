				...
				<section className={styles.contentArea}>
							...
							<>
								<Link href="/explorer/desktop?top=true" passHref>
									<div
										...
										style={
											router.asPath == '/explorer/desktop?top=true'
												? {
														backgroundColor: '#2e2e2e',
													}
												: {}
								...
								<Link href="/explorer/downloads?top=true" passHref>
									<div
										className={styles.navigationItem}
										style={
											router.asPath == '/explorer/downloads?top=true'
												? {
														backgroundColor: '#2e2e2e',
													}
												: {}
								...
								<Link href="/explorer/documents?top=true" passHref>
									<div
										className={styles.navigationItem}
										style={
											router.asPath == '/explorer/documents?top=true'
												? {
														backgroundColor: '#2e2e2e',
													}
												: {}
								...
								<Link href="/explorer/pictures?top=true" passHref>
									<div
										className={styles.navigationItem}
										style={
											router.asPath == '/explorer/pictures?top=true'
												? {
														backgroundColor: '#2e2e2e',
													}
												: {}
					...
					<div className={styles.content}>
						...
						<div className={`${styles.child} not_clickable`}>
							{props.component || (
								<>
									<p className={styles.emptyFolder}>This folder is empty.</p>
								</>
							)}
						</div>
					</div>
