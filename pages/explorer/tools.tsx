...
function Tools() {
	...
	return (
		<>
			<Head>
				<title>nateci - Tools</title>
				<link
					rel="canonical"
					href="https://www.natecirino.com/explorer/tools"
				/>
				...
				{/* OpenGraph */}
				<meta property="og:title" content="nateci - Tools" />
				<meta
					property="og:url"
					content="https://www.natecirino.com/explorer/tools"
				/>
				<meta
